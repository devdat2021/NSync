...
//   // Backgrounds
//   static const Color pageBg = Color(0xFF0C0C15);
//   static const Color surfaceBg = Color(0xFF13131E);
//   static const Color surfaceBorder = Color(0x12FFFFFF); // white 7%

//   // Text
//   static const Color textPrimary = Colors.white;
//   static const Color textMuted = Color(0x66FFFFFF); // white 40%
//   static const Color textSubtle = Color(0x59FFFFFF); // white 35%

//   // Accent
//   static const Color accentGreen = Color(0xFFC8FF47);
//   static const Color accentRed = Color(0xFFFF4D6A);

//   // Dividers / separators
//   static const Color divider = Color(0x12FFFFFF); // white 7%
//   static const Color tick = Color(0x4DFFFFFF); // white 30%

//   // Course palette — assign one per subject
//   static const List<Color> courseColors = [
...
//   static const TextStyle sectionFallback = TextStyle(
//     color: AppColors.textMuted,
//     fontSize: 18,
//   );
// }
